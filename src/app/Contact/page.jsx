              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {/* <p className="font-sans text-sm text-gray-600">+91 987 654 3210</p> */}
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-sm text-gray-600">rajindersinghmalik@gmail.com
</p>
                    {/* <p className="font-sans text-sm text-gray-600">support@hisarmedical.com</p> */}
                  </div>
                </div>
